...
\title{Macroeconomics and Inequality (MA)}
\date{University of Vienna \\ Summer term 2026}
...
\begin{frame}{About me}
  ...
  \begin{itemize}
  \item Austrian, married, two kids (5 and 8)
  \item Post-PhD experience
  \begin{itemize}
    \item since 2024: Assistant Prof. at University of Vienna
    \item 2020-24: Assistant Prof. (TT) at University of Amsterdam
  \end{itemize}
  \item Pre-PhD experience
  \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}{Plan for this course}

\begin{block}{Methods}
  \begin{itemize}
    \item Markov Chains
    \item numerical dynamic programming
    \item heterogeneous agent models (Bewley-Huggett-Aiyagari)
...
\begin{block}{Questions}
    \begin{enumerate}
      \item Does inequality matter for macroeconomic outcomes and policies?
      \item What are the sources of wealth inequality?
      \item Why is wealth inequality so different across countries? (Housing markets!)
      \item Should we tax wealth? Should we tax capital gains?
    \end{enumerate}
  \end{block}
\end{frame}

\begin{frame}{Disclaimer: Under construction}

        \begin{itemize}
        \item \emph{the course that I've always wanted}
        \item started in 2022 as 5-session PhD course in Amsterdam
        \item extended to 24-session MSc course \emph{last year} 
        \begin{itemize}
...
\begin{frame}{Course Logistics}
  ...
  \begin{column}{0.5\linewidth}
    ...
    \begin{block}{Your Tasks}
      ...
      \item midterm \& final exams
      \end{enumerate}
    \end{block} 
    
    \begin{block}{Participation points}
      \begin{itemize}
      \item need to be earned (!)
      \item (question, answer or comment)
      \item collect point at my desk after class
      \item actively participate in 15 sessions to get full points
      \end{itemize}
    \end{block}
  \end{column}

  \begin{column}{0.5\linewidth}
    \begin{block}{Computer assignments}
      \begin{itemize}
    ...
    \end{block}
     ...
     \begin{block}{Reading assignments}
      \begin{itemize}
      \item read a paper
      \item answer questions (in writing)
      \item discuss answers in class
      \end{itemize} 
     \end{block}
  \end{column}
\end{columns}

...
function solve_backward_vfi(par, ω_grid; price_paths, t_born = 0)
	...
	prices_last = prices_from_price_paths(price_paths, (J-1) + t_born)
...
#	ps = DimVector(range(p₀, p₁, length = J+1), j_dim, name = :p)
	...
	par = (γ = 2.0, σ = 2.0, β = 0.891944020390863, ξ = 0.16156632826246842, δ = 0.10322238929906932, y = ys, J, m = 0.0)

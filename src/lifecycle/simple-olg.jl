...
md"""
`simple-olg.jl` | **Version 1.2** | _last updated: March 6 2026_
"""
...
* Add plots for case with three types; analyze inequality
...
md"""
## Task 2: Two-period household's problem (2 points)

👉 (2.1 | 1 points) Implement the solution of the household's problem (assuming CRRA flow utility). Extend the given code and explain what you did. *(< $(limit2_1) words)*
"""
...
md"""
👉 (3.1 | 1 points) For a given capital stock ``K`` compute the vector of prices (i.e. interest rate ``r`` and the wage rate ``w``). Use the assumptions from the lecture. Explain what you did *(< $(limit3_1) words)*.
"""
...
manifest_format = "2.0"
project_hash = "a9e8259888e48566731b5d86e6e43a04b37cc5f9"

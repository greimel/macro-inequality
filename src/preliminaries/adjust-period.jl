...
# ╔═╡ eb35cd42-21d3-4b06-873a-20ad512de56e
# ╠═╡ skip_as_script = true
#=╠═╡
using PlutoUI: TableOfContents
  ╠═╡ =#

# ╔═╡ fa1b058e-0714-4cc5-8664-1153a9ffc0da
using Interpolations: linear_interpolation

# ╔═╡ dab21ecb-b4b8-4d5d-842d-8d8ae3799f64
using DimensionalData

# ╔═╡ 165f30c0-f819-40d2-b7df-75ad30c77e5a
# ╠═╡ skip_as_script = true
#=╠═╡
using Chain, DataFrameMacros, DataFrames
  ╠═╡ =#

# ╔═╡ 7eac4e0a-f4af-48e9-b237-125f30a70b7e
# ╠═╡ skip_as_script = true
#=╠═╡
...
#=╠═╡
let
	m = test_mortality # == mortality(:lifecycle)
	j_dim = DD.dims(m, :j)
...
manifest_format = "2.0"
project_hash = "f8ec1cd66ceb8a9977f04528349502ad75f166b8"

...
# ╔═╡ 3aa6b876-e50d-49a0-947d-a7e30fc33c91
md"""
* `solve_EGM_SS` ``\iff`` partial equilibrium
* 
"""

# ╔═╡ 01471967-eb71-4d30-92b8-11f76ba731fe
...
# ╔═╡ 6b57e933-ce16-4353-b1fe-dad354f23f1d
md"""
...
function partial_equilibrium(r_ss,w_ss,np)
...
let
	...
	(; out, c_ss, D) = partial_equilibrium(r, w, np)

	
	@info @test CSV.read("egm-test.csv", DataFrame) ≈ DataFrame(out)
	
	#CSV.write("egm-test.csv", DataFrame(out))
...
manifest_format = "2.0"
project_hash = "e66ff1186ecee97f42fa3c2a08dc656ab89fb953"

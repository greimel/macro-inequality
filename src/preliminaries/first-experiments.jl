...
# ╔═╡ 8e941067-c488-42a7-8cde-6797dacf1045
using QuantEcon: stationary_distributions

# ╔═╡ 51dc4d9d-9a34-400b-8a0d-c3da234cba18
using Interpolations: linear_interpolation

# ╔═╡ aae32ddd-80cc-4c9a-b4b0-45f65d26c675
using PlutoLinks: ingredients

# ╔═╡ 85f5485e-b9f7-4861-a0e6-a0bd350efa03
using DimensionalData

# ╔═╡ b497757e-bc7a-49f3-8014-4a6441febb4e
using Chain, DataFrameMacros, DataFrames

# ╔═╡ cf7e9842-ec3d-478f-a2b9-8f0a2813eeed
...
# ╔═╡ d128a8ba-e956-4be8-8ef8-d8cc7971b284
md"""
## "Local" packages
"""

# ╔═╡ 10166e1d-191a-435b-bf1b-d6335ebceafe
import PlutoTest

# ╔═╡ 2719f1df-460c-4d2e-8bd2-aa294aef5442
import StatsBase, Roots, Interpolations, QuantEcon

# ╔═╡ 992166b4-0b39-11f1-3af1-5ddd649a9129
EGMHousingRisk = ingredients("./egm-housing-risk.jl")

# ╔═╡ 13f170ce-29f1-4149-818e-b0f3f9b1b60e
AdjustPeriod = ingredients("./adjust-period.jl")

# ╔═╡ b4482e42-febe-4843-be9a-f569eef2f7bf
md"""
### imports for running `out_18_bequests`
"""

# ╔═╡ bc53dbf3-aabf-473e-98c4-cb1ff4a9d099
...
# ╔═╡ 8d0dd680-36b4-4419-968b-118cec7e43c9

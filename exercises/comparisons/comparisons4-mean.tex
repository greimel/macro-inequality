...
and the following comparison network $G$.%
    ...
    \begin{center}
        \includegraphics{comparisons/comparison-network-mean}
    \end{center}

    \begin{parts}
        \part[3] Let $\tilde \phi = \kappa_1 \phi$. Compute the social externality matrix $L$.
        ...
        \part[3] Compute $\frac{\partial}{\partial y^R} h_P$.
        ...
        \part[4] Interpret this result and discuss its relevance.
